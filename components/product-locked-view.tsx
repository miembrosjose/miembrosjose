    ...
    <main className="mx-auto w-full max-w-2xl px-6 py-20 text-center sm:py-32">
      ...
      <div className="mt-12 flex flex-wrap justify-center gap-3">
        {checkoutHref && (
          <a
            href={checkoutHref}
            className="border border-[#c9a961] bg-[#c9a961] px-7 py-3 text-[11px] font-semibold uppercase tracking-[0.3em] text-[#0a0a0f] transition-colors hover:bg-red-900 hover:border-red-900 hover:text-[#f5f5f7] [font-family:var(--font-geist-sans)]"
          >
            Desbloquear ahora
          </a>
        )}
