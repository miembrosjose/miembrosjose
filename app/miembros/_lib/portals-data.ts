...
export const INTEGRATION_PORTALS: IntegrationPortalDef[] = [
  {
    ...
    questions: [
      ...
      "¿Qué estoy dispuesto a soltar para avanzar?",
  ...
  },
  {
    ...
    questions: [
      ...
      "¿Dónde me ubico hoy dentro del mapa mayor?",
      "¿Qué desorden interior estoy listo para transformar?",
    ],
  ...
  },
  {
    ...
    questions: [
      ...
      "¿Qué patrón antiguo veo repetirse hoy en la humanidad?",
      "¿Qué puedo hacer para no repetir la caída atlante en mi propia vida?",
    ],
