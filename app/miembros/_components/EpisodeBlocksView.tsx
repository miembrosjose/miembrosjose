...
// Renderiza os blocks de texto de UM episódio numa zona específica
// (above_video | below_video). Read-only (sem edição) — esta é a view
// que o membro vê quando assiste o vídeo.

import { useEpisodeBlocks, type BlockPosition } from "../_lib/use-episode-blocks"
    ...
    >
      ...
      <style jsx global>{`
        ...
        .block-content blockquote {
          ...
          margin: 0.6rem 0; color: #a8a8c0; font-style: italic;
        }
        .block-content code {
          background: rgba(109, 74, 155, 0.18); color: #a78bca;
          padding: 0.1rem 0.35rem; border-radius: 4px;
          font-family: var(--font-mono, monospace); font-size: 0.85em;
        }
        .block-content pre {
          background: #0a0a18; border: 1px solid #251f30; border-radius: 6px;
        ...
        .block-content a {
          color: #a78bca; text-decoration: underline; text-underline-offset: 2px;
        }
        .block-content mark {
          color: inherit; padding: 0 0.15rem; border-radius: 2px;
        }
        .block-content img {
